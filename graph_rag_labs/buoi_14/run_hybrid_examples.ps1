...
"`n# Hybrid Search Examples" | Out-File -FilePath $outputFile -Encoding utf8 -Append

foreach ($q in $queries) {
    "## Query: $q`n" | Out-File -FilePath $outputFile -Encoding utf8 -Append
    .\.venv\Scripts\python.exe scripts\hybrid_search.py --query $q --candidate-k 20 --top-k 3 | Out-File -FilePath $outputFile -Encoding utf8 -Append
}

Write-Host "Hybrid Examples generated in $outputFile"
